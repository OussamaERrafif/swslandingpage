      ...
      <div className="max-w-6xl mx-auto w-full px-6 md:px-12 lg:px-20">
        ...
        >
          ...
          >
            {submitted ? (
              <motion.div
                className="bg-[#FF4D00]/10 border border-[#FF4D00] rounded-lg p-8 text-center"
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-neutral-900/50 border border-neutral-700 rounded-lg px-4 py-3 text-white placeholder-neutral-500 focus:outline-none focus:border-[#FF4D00] transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full bg-neutral-900/50 border border-neutral-700 rounded-lg px-4 py-3 text-white placeholder-neutral-500 focus:outline-none focus:border-[#FF4D00] transition-colors resize-none"
                    placeholder="Tell us about your project..."
                  />
                </div>

                <Button className="w-full bg-[#FF4D00] text-black hover:bg-[#FF4D00]/90 py-3 text-base font-semibold">
                  Send Message
                </Button>
              </form>
            )}
